...
background_image = Image.open("farm.jpg")

# Create a new image with the same dimensions as the background image
image = Image.new("RGBA", background_image.size)
...
# Draw the polygon on the image using brown color
draw.polygon(first, fill=brown_color)
